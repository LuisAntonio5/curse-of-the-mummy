...
class NameInput extends Menu {
	...
	addInput(game) {
		var bmd = game.phaser.add.bitmapData(510, 100);
		this.input = game.phaser.add.sprite(145, 280, bmd);

		this.input.canvasInput = new CanvasInput({
			canvas: bmd.canvas,
			fontSize: 40,
			...
			height: 100,
			padding: 5,
			backgroundImage: "assets/nothing.png",
